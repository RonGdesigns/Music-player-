...
private val SpindleColorScheme = darkColorScheme(
    ...
    secondaryContainer = Ground.Raised,
    onSecondaryContainer = Lamp.Bright,
    ...
    outline = Steel.Dim,
    outlineVariant = Steel.Engrave,
    surfaceContainer = Ground.Plate,
    surfaceContainerHigh = Ground.Plate,
    surfaceContainerHighest = Ground.Raised,
    error = SignalRed,
)
